...
export default class AllCourses extends React.Component{
    ...
    render(){
        //var labInformation=this.props.infrastructure.labInformation;
        //var courseTypeInformation=this.props.infrastructure.courseTypeInformation;
        let infrastructure=this.props.infrastructure;
        //console.log(infrastructure.toJS())
        return (
