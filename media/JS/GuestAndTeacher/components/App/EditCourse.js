...
export default class AddCourse extends React.Component {
    constructor(props) {
        ...
        let courseData = fromJS({
            ...
            arrangements: [
                { id: 1, key: 1, termWeek: "未选择", week: "未选择", lesson: "未选择", arrangementName: "" }
            ]
        })//immutable
        ...
        this.state = {
            currentStep: 1, courseData: courseData, showAddArrangmentModal: false, showEditArrangmentModal: false,
    ...
    formTwoHtml() {
        ...
        return (
            <div>
                ...
                <AddOrEditArrangmentModal title="添加课程" course={this.state.courseData} //传入课程信息数据结构，这样可以判断是实验还是非实验课
