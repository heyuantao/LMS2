...
export default class MyCourses extends React.Component {
    ...
    handleLabInformationSelectedChange(){
                        ...
                        <Row type="flex" justify="end" align="middle">
                            <Col>
                                ...
                                </Select>
                                {
                                    ...
                                    <Button style={{marginLeft:"10px"}} type="primary" onClick={()=>{this.handleAddCourse()}}>添加课程</Button>
                                }
